...
import { PiChatCircle as MessageSquare, PiCoins as Coins, PiCalendar as Calendar } from 'react-icons/pi';
...
export function NotificationsControls({ notifications }: NotificationsControlsProps) {
  ...
  const handleToggle = (key: 'notifyReplies' | 'notifyCredits' | 'notifySprints', value: boolean) => {
    const previousValue =
      key === 'notifyReplies'
        ? notifyReplies
        : key === 'notifyCredits'
